 ...
 */
public class CopiaSensorService implements SensorEventListener {
    ...
    private float xmax = -60f, xmin=60f;

    public CopiaSensorService(Activity contextActivity){
    ...
    public double getTheta(){
        ...
        return 2.0*Math.asin(a*magnetometerReading[2]+b);
    }
